...
$('header#header').ready(function () {
  ...
  $('.header__left-search').click(function () {
...
var boxBorderSwiper = new Swiper('.box-border-slider', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 50,
  centeredSlides: true,
...
$('#respond').submit(function () {
  if ($.trim($("#email").val()) === "" || $.trim($("#author").val()) === "") {
    Swal.fire('اوه مشکلی پیش آمده!', 'شما باید فیلد های ایمیل و نام را وارد کنید', 'error');
    return false;
  }
});
"use strict";
