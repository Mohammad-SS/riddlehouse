			...
			<div class="swiper-wrapper">
				...
				while ( $the_query->have_posts() ) {
					...
					<div class="swiper-slide">
						...
						<img
							data-src="<?= $post_thumb_url ?>"
							class="swiper-lazy" alt="<?= get_the_title() ?>"
						/>
						<!-- Preloader image -->
						...
						<div class="slide-content">
							...
							<div class="slide-content__title"><a href="<?= the_permalink() ?>"><h1> <?= get_the_title() ?></h1></a></div>
							<div class="slide-content__more">
								<div class="slide-content__more-right"><i class="fal fa-comment"></i><?= get_comments_number($post_id) ?> دیدگاه </div>
								<div class="slide-content__more-center"><i class="fal fa-clock"></i><?= get_the_date() ?></div>
